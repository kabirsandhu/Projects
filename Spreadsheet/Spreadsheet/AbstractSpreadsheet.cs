...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        ///  The method starts at the start node and adds it to a list of visited nodes. 
        ///  It then gets all the dependents of the start node and recursively calls the visit method on each dependent.
        ///  All unvisted dependents get visited with each call and all are added to the changed list. 
        ///  The changed list conatains all the cells which are directly or indirectly dependent on the very first start cell.
        /// </summary>
